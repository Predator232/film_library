...
INSERT INTO `users` (`username`, `email`, `password`, `subscription_id`, `subscription_start`, `subscription_end`, `is_admin`) VALUES
('admin', 'admin@filmoteka.ru', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 3, CURRENT_TIMESTAMP, DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 30 DAY), 1),
('user1', 'user1@filmoteka.ru', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 2, CURRENT_TIMESTAMP, DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 30 DAY), 0),
('user2', 'user2@filmoteka.ru', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 1, CURRENT_TIMESTAMP, DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 30 DAY), 0);
...
('Новый фильм Кристофера Нолана', 'Кристофер Нолан анонсировал работу над новым фильмом, который выйдет в 2025 году.', 'nolan.jpg', '2025-04-01 10:00:00'),
('Фестиваль кино в Каннах', 'Объявлены даты проведения Каннского кинофестиваля 2025 года.', 'cannes.jpg', '2025-04-02 11:30:00'),
('Новые технологии в кино', 'Крупные студии начинают использовать искусственный интеллект для создания спецэффектов.', 'tech.jpg', '2025-04-03 09:15:00');
...
INSERT INTO `movies` (`title`, `release_year`, `director_id`, `genre_id`, `news_id`, `description`, `duration`, `poster_url`, `average_rating`) VALUES
('Начало', 2010, 1, 3, 1, 'Вор проникает в сны людей, чтобы украсть идеи, но получает задание — внедрить мысль.', 148, 'inception.jpg', 8.8),
('Крестный отец', 1972, 2, 1, NULL, 'Классическая история о мафиозной семье Корлеоне.', 175, 'godfather.jpg', 9.2),
('Криминальное чтиво', 1994, 3, 1, NULL, 'История о преступниках, рассказанная в нелинейном повествовании.', 154, 'pulpfiction.jpg', 8.9),
('Бойцовский клуб', 1999, 3, 1, NULL, 'История о мужчине, который создает подпольный бойцовский клуб.', 139, 'fightclub.jpg', 8.8),
('Матрица', 1999, 1, 3, NULL, 'Хакер узнает, что реальность - это симуляция.', 136, 'matrix.jpg', 8.7),
('Форрест Гамп', 1994, 2, 1, NULL, 'История простого человека, который становится свидетелем важных исторических событий.', 142, 'forrestgump.jpg', 8.8),
('Титаник', 1997, 2, 1, NULL, 'История любви на фоне гибели легендарного лайнера.', 195, 'titanic.jpg', 7.8),
('Аватар', 2009, 1, 3, NULL, 'История о человеке, который становится частью инопланетной цивилизации.', 162, 'avatar.jpg', 7.8),
('Темный рыцарь', 2008, 1, 1, NULL, 'Бэтмен противостоит Джокеру в борьбе за Готэм.', 152, 'darkknight.jpg', 9.0),
('Побег из Шоушенка', 1994, 2, 1, NULL, 'История о невиновном банкире, который планирует побег из тюрьмы.', 142, 'shawshank.jpg', 9.3);
